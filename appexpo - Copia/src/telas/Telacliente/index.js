...
export default function Telacliente() {
    ...
    const storeData = async (value) => {
        try{
            const inputemail = JSON.stringify(value)
            await AsyncStorage.setItem('my-key', inputemail);
        } catch (e) {}
    };
    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            placeholder="Confirmar"
            />
            <TouchableOpacity style={styles.botaoavanço} onPress={ () => navigation.navigate('Cadastrocliente')}>
